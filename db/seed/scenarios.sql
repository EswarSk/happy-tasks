...
INSERT INTO projects (id, organization_id, name, description, metadata, version, created_at, updated_at) VALUES
    (
        ...
        'Scale & Scenario Lab',
        '[Shared demo project — every new account joins this one automatically] Ten-thousand-task workspace covering scale, collaboration, comments, filters, dependencies, conflicts, and UI edge cases.',
    ...
    (
        ...
        '00000000-0000-7000-8000-000000000100',
        'Empty Sandbox',
        '[Shared demo project — every new account joins this one automatically] A deliberately empty project for loading, empty-state, first-task, and project-isolation tests.',
